...
import 'package:Shreeya/services/audio_service.dart';
import 'package:Shreeya/services/data_manager.dart';
import 'package:Shreeya/services/logger_service.dart';
...
late ShreeyaAudioHandler audioHandler;
...
class Shreeya extends StatefulWidget {
  ...
  static Future<void> updateAppState(
    ...
    final state = context.findAncestorStateOfType<_ShreeyaState>()!;
  ...
  @override
  _ShreeyaState createState() => _ShreeyaState();
}

class _ShreeyaState extends State<Shreeya> {
  void changeSettings({
    ThemeMode? newThemeMode,
    Locale? newLocale,
    Color? newAccentColor,
...
Future<void> initialisation() async {
  try {
    ...
    audioHandler = await AudioService.init(
      builder: ShreeyaAudioHandler.new,
      config: const AudioServiceConfig(
        androidNotificationChannelId: 'com.Shreeyadahal.music',
        androidNotificationChannelName: 'Shreeya',
